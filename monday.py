...
#        models.TL.Assigned_To == 6,
    ...
    for usertof in userlist:
        if 1==1:
            ...
            list_data.append({'Non - chargable': final_combined_datab})

            # for key in ['end_time', 'hold', 'break', 'time_diff_work', 'call', 'meeting', 'in_progress', 'completed']:
            #         final_combined_datab[key] = [convert_to_duration(final_combined_datab[key])] 

            # for key in ['end_time', 'hold', 'break', 'time_diff_work', 'call', 'meeting', 'in_progress', 'completed']:
            #     final_combined_datab[key] = [format_duration(final_combined_datab[key])]

            print(final_combined_datab,'###############################################################')
